...
const organizationJsonLd = {
  ...
  description:
    'EnsoTech Studio cung cấp dịch vụ phần mềm theo yêu cầu, security audit, dashboard dữ liệu và triển khai AI/Agentic AI cho doanh nghiệp nhỏ, chủ shop và startup.',
